                 ...
                 SEXP sburnin, SEXP sstep,  SEXP siter)
{
  ...
  for( i =1; i <= iterations; i++ ){
    ...
    rmvnorm( mc, Pc, betap, "V"); //solo detSigma => "N"
    ...
    //Rprintf("ln:%f lo:%f qn:%f qo:%f\n", lognew, logold, qnew, qold);
    //R_FlushConsole();
